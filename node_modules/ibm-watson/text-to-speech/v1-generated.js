...
var TextToSpeechV1 = /** @class */ (function (_super) {
    ...
    TextToSpeechV1.prototype.addCustomPrompt = function (params) {
        var _params = __assign({}, params);
        var requiredParams = ['customizationId', 'promptId', 'metadata', 'file'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
            return Promise.reject(missingParams);
        }
    ...
    TextToSpeechV1.prototype.getCustomPrompt = function (params) {
        var _params = __assign({}, params);
        var requiredParams = ['customizationId', 'promptId'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
            return Promise.reject(missingParams);
        }
    ...
    TextToSpeechV1.prototype.createSpeakerModel = function (params) {
        var _params = __assign({}, params);
        var requiredParams = ['speakerName', 'audio'];
        var missingParams = ibm_cloud_sdk_core_1.getMissingParams(_params, requiredParams);
        if (missingParams) {
            return Promise.reject(missingParams);
        }
